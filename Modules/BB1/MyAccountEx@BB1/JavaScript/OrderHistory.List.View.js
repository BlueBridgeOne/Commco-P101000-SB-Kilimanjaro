...
//@module OrderHistory
define('OrderHistory.List.View', ['SC.Configuration', 'GlobalViews.Pagination.View', 'GlobalViews.ShowingCurrent.View', 'ListHeader.View', 'Backbone.CompositeView', 'Backbone.CollectionView', 'OrderHistory.List.Tracking.Number.View', 'RecordViews.Actionable.View', 'Handlebars'

	, 'order_history_list.tpl'

	, 'Backbone', 'underscore', 'jQuery'
], function (
	Configuration, GlobalViewsPaginationView, GlobalViewsShowingCurrentView, ListHeaderView, BackboneCompositeView, BackboneCollectionView, OrderHistoryListTrackingNumberView, RecordViewsActionableView, Handlebars
				...
				var self = this,
					records_collection = new Backbone.Collection(this.collection.map(function (order) {
						...
						var columns = [{
								...
								value: order.get('custbody_bb1_so_title').value
							}, {
							...
							},
							{
								...
								type: 'status',
								name: 'otherrefnum',
								value: order.get('otherrefnum').value
							}
						];
