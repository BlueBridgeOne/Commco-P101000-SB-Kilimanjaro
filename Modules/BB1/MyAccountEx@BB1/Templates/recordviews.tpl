...
<tr class="recordviews-row" data-item-id="{{id}}" data-navigation-hashtag="{{detailsURL}}" data-action="navigate">
	...
	{{#if showView}}
	<td><a class="recordviews-view-anchor" href="#" data-touchpoint="{{touchpoint}}" data-id="{{id}}" data-hashtag="{{detailsURL}}" {{#if showInModal}}data-toggle="show-in-modal"{{/if}}>View</a></td>
	{{/if}}
