...
<section>
	<header>
		<h2 class="order-history-details-order-title" data-origin='{{originName}}'>
			<span class="order-history-details-order-title"></span><b> <span class="order-history-details-order-number">{{model.tranid}}</span></b>
		</h2>
	</header>
		...
		<div class="order-history-details-header-row">
			<div class="order-history-details-header-col-left">
				<p class="quote-details-header-info-request-date">
						<span class="quote-details-header-label-request-date">{{translate 'Transaction Title: '}}</span>
						<span class="quote-details-header-value-date">{{model.options.custbody_bb1_so_title}}</span>
					</p>
				...
				{{/if}}
				<p class="order-history-details-header-quote-info">
					{{translate '<span class="order-history-details-header-quote-info-quote-label">Status: </span> <span class="order-history-details-header-date">$(0)</span>' model.status.name}}
				</p>
			</div>
