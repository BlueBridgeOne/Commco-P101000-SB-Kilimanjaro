	...
	,	get: function ()
		{
			...
			if (ModelsInit.session.isLoggedIn2() && this.isSecure)
			{
				...
				this.fields = this.fields || ['isperson', 'email', 'internalid', 'name', 'overduebalance', 'phoneinfo', 'companyname', 'firstname', 'lastname', 'middlename', 'emailsubscribe', 'campaignsubscriptions', 'paymentterms', 'creditlimit', 'balance', 'creditholdoverride','altphone'];
	...
	,	update: function (data)
		{
			...
			if(data.altphone !== '')
			{
			customerUpdate.altphone= data.altphone;
			}
